...
export default function Footer() {
  return (
    <footer className="bg-muted px-28 py-8 md:py-12">
      <div className="max-w-7xl flex justify-between gap-8">
        <div className="grid gap-4">
          <div className="text-sm text-muted-foreground">&copy; 2024 MyBooks. All rights reserved.</div>
          <div className="text-sm text-muted-foreground">Developed by Pedro Lima.</div>
        </div>
        <div className="grid gap-4">
